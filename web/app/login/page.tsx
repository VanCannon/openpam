    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center p-4">
      <div className="bg-card  rounded-2xl shadow-2xl p-8 max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-foreground  mb-2">OpenPAM</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4 mb-8">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg border border-input    focus:ring-2 focus:ring-purple-500 outline-none"
        ...
        <div className="relative mb-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-card  text-muted-foreground">Or use Dev Mode</span>
          </div>
        </div>

        <div className="mb-4">
          <h2 className="text-lg font-semibold text-foreground  mb-2">Development Mode</h2>
