      ...
      <main className="w-full px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">System events and activity logs</p>
          </div>
          ...
          <div className="flex gap-2">
            <select
              ...
              className="px-4 py-2 border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
        ...
        {loadingLogs ? (
          ...
          <div className="text-center py-12"><p className="text-muted-foreground">No audit logs found</p></div>
        ) : (
              ...
              <table className="min-w-full divide-y divide-border">
                <thead className="bg-background">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Event Type</th>
