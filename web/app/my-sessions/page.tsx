                ...
                <div className="mb-8">
                    <div className="flex justify-between items-center mb-4">
                        <div>
                            ...
                            <p className="mt-2 text-muted-foreground">View and replay your session history</p>
                        </div>
                                            ...
                                            >
                                                <div className="flex items-start justify-between">
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <p className="text-sm font-semibold text-foreground truncate" title={accountName}>
                                                            Account: {accountName}
                                                        </p>
                                                        <p className="text-xs text-muted-foreground truncate mt-1" title={targetName}>
                                                            Resource: {targetName}
                                                        </p>
